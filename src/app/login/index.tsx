  ...
  const setIpHostData = async () => {
    ...
    if (time - nowPressTime < 1000) {
      if (clickCount === 4) {
        ...
        const value9 =
          (await AsyncStorage.getItem("lockMoveDistance")) || lockMoveDistance;
        setlockMoveDistance(value9);
        const value10 =
          (await AsyncStorage.getItem("lockMoveAngle")) || lockMoveAngle;
  ...
  return (
    <SafeAreaView>
      ...
      >
        ...
        >
          <Text style={styles.title} onPress={setIpHostData}>
            骨科手术定位机器人
          </Text>
          <View style={styles.logingContainer}>
            ...
            <TouchableOpacity onPress={handleLogin} disabled={loading}>
              <Text style={[styles.btnLogin, { opacity: loading ? 0.3 : 1 }]}>
                登录
              </Text>
            </TouchableOpacity>
          </View>
      ...
      {/* <Link href="/sign-in?n=10">go content</Link> */}
    </SafeAreaView>
  );
};
